function(source_group_recursive module_name folder MODULE_FILES)

	set(SOURCE_LIST "")
	set(SOURCE_COUNT_LIST "")
	set(SOURCE_GROUP_LIST "")
	
	set(CLEAR_MODULE_FILES "")
	
	foreach(f ${MODULE_FILES})
		file(RELATIVE_PATH GRP "${CMAKE_CURRENT_SOURCE_DIR}/${folder}" ${f})
		...
		if("GRP" STREQUAL "")  
			string(CONCAT CLEAR_MODULE_FILES "${CLEAR_MODULE_FILES} ${FNAME}")         
		else()
	...
	source_group("${module_name}\\" FILES "${CLEAR_MODULE_FILES}")
	...
	foreach(GRP ${SOURCE_GROUP_LIST})
		...
		string(CONCAT GRP "${module_name}/${GRP}\\")
		#MESSAGE("${GRP}")
