...
namespace MachineLearning
{
	class CrossValidation
	{
		...
		public:
			...
			static std::pair<double, double> test(Predictor* _predictor, Pool& _pool, size_t folds, std::string testing_category_name, const std::string& outdir, bool print = false);
